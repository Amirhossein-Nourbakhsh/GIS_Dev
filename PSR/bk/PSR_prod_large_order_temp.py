...
########################### LOCAL ##################################
    OrderIDText = '826721'
    scratchfolder = r"\\cabcvan1gis006\GISData_testing\test1\psrlargep10"  # for regular .shp etc.
...
##    datalyr_wetlandNY = PSR_config.datalyr_wetlandNY
    ...
    orderGeometry= os.path.join(scratchfolder,"part10.shp")
