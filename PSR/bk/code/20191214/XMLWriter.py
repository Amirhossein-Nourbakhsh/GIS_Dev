...
def do_request1(body):
       ...
       try:
           ...
           con = cx_Oracle.connect('eris_gis/gis295@GMPROD.glaciermedia.inc')
           cur=con.cursor()
           #body1="""%s""" %(body)
           ...
           if r == 'D':
              ...
              print 'AcceptSites fails, will fail purposely here' + 1
           print >> out_web, r, ":oracle finish", datetime.datetime.now()

       except Exception as e:
           #error, = e.args
           print >> out_web,"AcceptSites returns D"
           print >> out_web,e
...
try:
   ...
   for row in fclass:
      ...
      order.append(str(row.Elevation))
