...
##    data_topo = PSR_config.data_topo#"E:\GISData\Topo_USA\masterfile\Cell_PolygonAll.shp"
    ...
    eris_wells = r"\\cabcvan1gis007\GISData\PSR\python\mxd\ErisWellSites.lyr"   #which contains water, oil/gas wells etc.
...
##    datalyr_wetlandNY = PSR_config.datalyr_wetlandNY
    ...
    orderGeometry= os.path.join(scratchfolder,"ordergeometryCopy.shp")
