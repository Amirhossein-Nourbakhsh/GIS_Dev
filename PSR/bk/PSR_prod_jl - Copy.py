...
########################### LOCAL ##################################
    OrderIDText = '844521'
    scratchfolder = r"W:\Data Analysts\Alison\GIS\PSR_SCRATCHY\20200226145"  # for regular .shp etc.
...
##            del in_rows
            ...
            for in_row in in_rows:
                ...
                query = cur.callproc('eris_psr.InsertFlexRep', (OrderIDText, erisid, '10685', 2, 'N', 6, 'Unit Description: ', in_row.UNITDESC))
            del in_row
            del in_rows
