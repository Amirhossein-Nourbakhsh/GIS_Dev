...
# LOCAL #########################################################################
    OrderIDText = '896017'
    OrderNumText = r"20200721162"
    scratchfolder = r'C:\Users\HKiavarz\Documents\Scratch\20200721162'
...
# ============================================================================================================================
    ...
    print ('NAD 1983 UTM Zone %sN'%UTMvalue)
    print (orderGeometry)
    print (orderGeometryPR)
...
##    orderCentreSHP = orderCentreSHPPR
    ...
    arcpy.Integrate_management(wells_mergePR, '0.5 Meters')
