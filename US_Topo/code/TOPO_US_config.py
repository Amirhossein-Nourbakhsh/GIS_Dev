...
mxdpath = os.path.join(testpath, r"python\mxd")
prjpath = os.path.join(testpath, r"python\projections")
...
# other
logfile = os.path.join(testpath, r"python\log\USTopoSearch_Log.txt")
